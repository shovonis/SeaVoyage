...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_BoatController p_BoatController;
        ...
        public static SteamVR_Input_ActionSet_BoatController BoatController
        {
            get
            {
                return SteamVR_Actions.p_BoatController.GetCopy<SteamVR_Input_ActionSet_BoatController>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_BoatController = ((SteamVR_Input_ActionSet_BoatController)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_BoatController>("/actions/BoatController")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.BoatController};
        }
    }
}
