    ...
    public class InputBindings
    {
        ...
        public float GetAxis(string name)
        {
            try
            {
                ...
                // if (SteamVR_Input.GetStateDown("Throttle", SteamVR_Input_Sources.Any))
                // {
                //     Debug.Log("Throttle On");
                // }

            // Debug.Log("Get Axis Call: " + Input.GetAxis(name));
                /// ************************************************************************ /// 
        ...
        public bool GetButtonDown(string name)
        {
            try
            {
                ...
                /// ************************************************************************ ///
                ///
                // Debug.Log("Get Button Call: " + Input.GetAxis(name));
